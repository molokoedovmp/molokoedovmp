...
const experiences = [
  ...
  {
    company: "ВШЭ × Контур",
    position: "Победитель хакатона",
    location: "Москва",
    period: "2024",
    description: [
      "Участие в хакатоне Высшей школы экономики совместно с Контур",
      "Разработка прототипа и защита решения перед жюри",
      "Победа в треке и признание лучшим решением среди участников"
    ]
  }
];
